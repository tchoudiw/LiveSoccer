...
public class MatchAvenirActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) { 
		...
		listMatchSuivie.add("332876");	
		listMatchSuivie.add("332875");
		listMatchPari.add("332873");	
		listMatchPari.add("332872");
		...
		String xmlString2 = parser.getXmlFromUrl(dataj.getAvenirUrl());
